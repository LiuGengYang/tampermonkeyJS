...
import { Env, type Position } from '../types'
...
<template>
    <div ref="switcher" class="env-switcher" :style="{ left: pos.x + 'px', top: pos.y + 'px' }">
        <div ref="envSwitcherBtn" class="env-switcher-btn" @mousedown.stop="dragStart" @click.stop="handleClick">
            <svg t="1757574763114" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="6581" width="20" height="20">
                <path
                    ...
                    fill="#ffffff" p-id="6582" data-spm-anchor-id="a313x.search_index.0.i1.28003a81ISwaJq"
                    class="selected"></path>
            </svg>
        </div>
        <div class="account-icon" @mousedown.stop @click.stop="showDialog">
            <svg t="1758098433552" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="17033" width="25" height="25">
                <path
                ...
                <path
                    ...
                    fill="#4C79ED" p-id="17037"></path>
            </svg>
        </div>
        <SwitchBtn v-model:show="optionsShow" :parentPos="pos" ref="switchBtn" />
    </div>
